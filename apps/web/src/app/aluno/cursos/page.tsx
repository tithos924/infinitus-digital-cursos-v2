...
export default function AlunoMeusCursosPage() {
  const { token } = useAuth();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-black/50 dark:text-white/50 mt-1">Os cursos a que tens acesso.</p>
      </div>
          ...
          >
            ...
            <div className="p-5 space-y-2">
              ...
              {e.course.description && (
                <p className="text-xs text-black/50 dark:text-white/50 line-clamp-2">{e.course.description}</p>
              )}
